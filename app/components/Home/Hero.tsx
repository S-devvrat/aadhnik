...
export default function Hero() {
  ...
  useEffect(() => {
    ...
    const draw = () => {
      ...
      for (let i = 0; i < config.waveCount; i++) {
        ...
        g.addColorStop(0.2, `rgba(${c.r},${c.g},${c.b},${c.a})`);
        g.addColorStop(
          0.8,
          `rgba(${i === 1 ? 79 : 245},${i === 1 ? 143 : 215},${i === 1 ? 255 : 125},${c.a * 1.2})`,
        );
        g.addColorStop(1, `rgba(${c.r},${c.g},${c.b},0)`);
        ctx.strokeStyle = g;
        ctx.lineWidth = i === 1 ? 55 : 40;
        ctx.lineCap = "round";
        ctx.lineJoin = "round";
        ctx.shadowBlur = 32;
        ctx.shadowColor = `rgba(${c.r},${c.g},${c.b},${c.a * 0.8})`;
        for (let x = 0; x <= W; x += 6) {
          const yo =
            Math.sin(x * (0.0025 + i * 0.001) + time + i * 2) * 65 +
            Math.cos(x * (0.006 - i * 0.0015) - time * 1.2 + i) * 35;
  ...
  return (
    <section
      ...
      style={{ background: "#07090f", position: "relative", zIndex: 1 }}
    >
      <style>{`
      ...
      <div className="pointer-events-none absolute inset-0 z-10">
        ...
        <div
          style={{
            ...
            borderRadius: "50%",
            background:
              "radial-gradient(circle,rgba(79,143,255,0.12) 0%,transparent 65%)",
          }}
        />
      </div>
      ...
      <header className="relative z-30 flex items-center justify-between lg:mt-0 -mt-10 px-6 py-6 md:px-14" />

      <div className="relative z-20 flex min-h-[calc(100vh-80px)] flex-col items-center justify-center pt-32 md:pt-40 px-4 sm:px-6 md:px-12 lg:px-20 text-center">
        <h1
          style={{
        ...
        >
          <button
            ...
            style={{
              ...
              boxShadow:
                "0 0 36px 8px rgba(59,130,246,0.32), inset 0 1px 0 rgba(255,255,255,0.18)",
            }}
          >
            Explore Our Works
            <span
